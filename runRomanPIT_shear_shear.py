...
Q1_std = Q1_priors[f'{args.i_depth}{args.i_ellmax}']
print(f'ell max = {ellmax}; neff = {neff}; Q1 std = {Q1_std}')
...
sample_main(sample_params,args.nsteps,args.nwalkers,1,chain_file+f'_{args.nsteps}', blind=False, pool=MPIPool())
