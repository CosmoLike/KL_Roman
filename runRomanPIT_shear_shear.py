...
if args.baryPCA==1:
    ...
    chain_output_file = "Roman_WL_%d%d%d_ss_Ncl15_Ntomo10_barymarg_illustris"%(args.i_depth, args.i_area, args.i_ellmax)
    print "Baryonic effects marginalized! (illustris)"
elif args.baryPCA==0:
    samp_bary = False
    chain_output_file = "Roman_WL_%d%d%d_ss_Ncl15_Ntomo10_fixbary"%(args.i_depth, args.i_area, args.i_ellmax)
