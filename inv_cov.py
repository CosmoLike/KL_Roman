...
# covariance matrix
infile =['Total_Cov_Matrix/WFIRST_KL_ssss_cov_Ncl10_Ntomo10_sigmae08_DEl95CPL']
...
# data vector
data= ['/home/u17/jiachuanxu/CosmoLike/KL_WFIRST/datav/WFIRST_KL_shear_shear_opti_DEl95CPL']

# output file name
outname=['WFIRST_KL_DEl95CPL']
