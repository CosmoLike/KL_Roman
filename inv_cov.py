...
# covariance matrix
infile =['Total_Cov_Matrix/WFIRST_Tully_Fisher_Ngal8.00_Area2000.00_ssss_cov_Ncl10_Ntomo30_sigmae0.08_grismzdist_DEl95CPL']
...
# data vector
data= ['/home/u17/jiachuanxu/CosmoLike/KL_WFIRST/datav/WFIRST_KL_shear_shear_opti_Ntomo30_Ncl10_zdistgrism_DEl95CPL']

# output file name
outname=['WFIRST_KL_Ntomo30_Ncl10_sigmae0.08_grismzdist_DEl95CPL']
...
nshear = 465 	# number of shear tomographic power spectra, sigma_{i=1}^{i=tomo.Nbin}
ncl=10		# number of ell-bins
