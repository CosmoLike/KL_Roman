...
data_vector_file = "datav/DESI2_KL_%d0_shear_shear_Ntomo%d_Ncl%d_fid"
...
chain_output_file = "chains/DESI2xLSST_KL_s8split_only_zlow015_%d%d_ss_Ncl%d_Ntomo%d"
...
invcov_file = os.path.join(outdirname, 
...
initdatainvbary(invcov_file ,data_file, bary_file)
...
sample_main(sample_params,5000,280,1,chain_file+"_5000", blind=False, pool=MPIPool(), KL=True)
