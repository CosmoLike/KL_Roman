...
data_file = os.path.join(dirname, "datav/WFIRST_KL_shear_shear_opti_grism_Ntomo10_Ncl10_sigmae0.05")
...
### WFIRST_KL_Ntomo10_Ncl10_sigmae0.08_shear_shear_inv 
...
bary_file = os.path.join(dirname, "datav/WFIRST_KL_shear_shear_opti_grism_Ntomo10_Ncl10_sigmae0.05")
#chain_file = "/extra/jiachuanxu/WFIRST_forecasts/chains/like_WFIRST_KL_SN10_opti_shear_shear_sys_sigmae0.05"
chain_file = "/xdisk/timeifler/jiachuanxu/WFIRST_forecasts/chains/like_WFIRST_%s_shear_shear_sys_Ntomo%2d_Ncl%2d_sigmae%.2f_%s_bary"%(strat,Ntomo, Ncl, sigmae,Pco)
...
initpriors_IA_bary("photo_KL", "shear_KL", "none", "none", False, 3.0, 1.2, 3.8, 2.0, False, 16.0, 5.0, 0.8)
